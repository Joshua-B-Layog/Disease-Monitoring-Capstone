    ...
    <div className="resident-page">
        ...
        {CHO_UNITS.map(u => (
          <button key={u.id} onClick={() => setSelected(u)}
            style={{
              ...
              fontSize: '17px', cursor: 'pointer', textAlign: 'center',
              transition: 'all 0.2s',
            }}>
            {u.name}
          </button>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ margin: 0, fontStyle: 'italic', color: 'rgba(255,255,255,0.85)', fontSize: '17px' }}>
            "{selected.motto}"
          </p>
        </div>
        ...
        <div style={{ padding: '24px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '24px' }}>
            <div style={{ background: 'var(--input-bg)', borderRadius: '8px', padding: '16px', border: '1px solid var(--border-color)' }}>
              <div style={{ fontSize: '17px', fontWeight: '700', color: '#129968', marginBottom: '8px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                Our Mission
              </div>
              <p style={{ margin: 0, fontSize: '17px', lineHeight: '1.6', color: 'var(--text-main)' }}>
                {selected.mission}
              </p>
            </div>
            <div style={{ background: 'var(--input-bg)', borderRadius: '8px', padding: '16px', border: '1px solid var(--border-color)' }}>
              <div style={{ fontSize: '17px', fontWeight: '700', color: '#1d4ed8', marginBottom: '8px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                Our Vision
              </div>
              <p style={{ margin: 0, fontSize: '17px', lineHeight: '1.6', color: 'var(--text-main)' }}>
                {selected.vision}
          ...
          <div style={{ marginBottom: '24px' }}>
            <h4 style={{ margin: '0 0 12px', fontSize: '17px', fontWeight: '700', color: 'var(--text-main)' }}>
              Staff
            </h4>
              ...
              {selected.staff.map((s, i) => (
                <div key={i} style={{
                  ...
                  <div style={{
                    ...
                    justifyContent: 'center', color: '#fff', fontWeight: '700', fontSize: '17px', flexShrink: 0,
                  }}>
          ...
          <div style={{ marginTop: '20px' }}>
            <h4 style={{ margin: '0 0 8px', fontSize: '17px', fontWeight: '700', color: 'var(--text-main)' }}>
              Covered Barangays
            </h4>
