      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          ...
          <div style={{
            ...
            {SYMPTOMS.map((s, i) => (
              <div key={i} style={{
                ...
                <div style={{ fontSize: '17px', color: 'var(--text-muted)', marginTop: '2px' }}>{s.desc}</div>
              </div>
            ))}
          </div>
        </Section>
        ...
        <Section title="Warning Signs of Severe Diseases" icon="⚠️" danger>
          <div style={{
            ...
            <p style={{
              margin: '0 0 12px', fontSize: '17px', fontWeight: '600', color: 'var(--warning-text)',
            }}>
              Seek immediate medical care if you experience:
            </p>
            <ul style={{ margin: 0, paddingLeft: '20px', color: 'var(--warning-text)', fontSize: '17px', lineHeight: '2' }}>
          ...
          <div style={{
            ...
            <div style={{ fontSize: '17px', fontWeight: '700', color: 'var(--success-text)' }}>
              🚑 If you have any of these symptoms, GO TO THE HOSPITAL IMMEDIATELY.
            </div>
            <div style={{ fontSize: '17px', color: 'var(--success-text)', marginTop: '4px' }}>
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <span style={{
          padding: '2px 8px', borderRadius: '4px', fontSize: '17px', fontWeight: '600',
      ...
      <div style={{ fontSize: '17px', fontWeight: '600', color: 'var(--text-main)' }}>{title}</div>
      <div style={{ fontSize: '17px', color: 'var(--text-muted)', marginTop: '2px' }}>{desc}</div>
    </div>
  );
}
